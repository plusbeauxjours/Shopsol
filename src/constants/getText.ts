...
​
  ...
  - 전화번호 : 070-8633-1119
  - 주 소 : 서울특별시 마포구 신수동 백범로 35 아루페관 3층 오렌지팜(스마일게이트)
...
export const getText3 = () =>
  ...
  ​
  제 12 조 (위치정보관리책임자의 지정){"LIST": ["D", false, "Xx", false, "Adf", false], "PHOTO_CHECK": "1", "STORE_SEQ": "5168", "TITLE": "Ddc", "createdData": ""}
  ...
  1. 상호 : 위솝
  2. 주소 : 서울특별시 마포구 신수동 백범로 35 아루페관 3층 오렌지팜(스마일게이트)
  3. 대표전화 : 070-8633-1119
  ​
  부칙
  ​
  (시행일) 본 약관은 2018년 1월 1일부터 시행합니다.
